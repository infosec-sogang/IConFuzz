module IConFuzz.Main

open Utils

let printUsage () =
  printLine "Usage: 'dotnet IConFuzz.dll <fuzz|replay> <options...>'"
  printLine "fuzz : Mode for test case generation with fuzzing."
  printLine "       Use 'dotnet IConFuzz.dll fuzz --help' for details."
  printLine "replay : Mode for replaying generated test cases."
  printLine "         Use 'dotnet IConFuzz.dll replay --help' for details."
